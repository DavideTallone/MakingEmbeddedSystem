...
static volatile bool ButtonStateChanged=false;	//set by interrupt callback
...
void tc_callback_to_toggle_led(struct tc_module *const module_inst){
	if(!ButtonStateChanged){return;}				//Button interrupt has not been fired, do nothing and return
